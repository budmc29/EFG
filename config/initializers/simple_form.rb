...
SimpleForm.setup do |config|
  ...
  config.wrappers :checkbox, tag: "div",
                             class: "control-group",
  ...
  # form option). These validations are enabled in SimpleForm's internal config
  # but disabled by default in this configuration, which is recommended due to
  # some quirks from different browsers. To stop SimpleForm from generating the
