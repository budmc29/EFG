...
class LoanAlerts::Base
  ...
  def alert_range
    @alert_range ||= begin
      ...
      medium_priority_start_date = 10.weekdays_from(high_priority_start_date)
      low_priority_start_date    = 20.weekdays_from(medium_priority_start_date)
      ...
      end_date = {
        "high"   => 10.weekdays_from(high_priority_start_date),
        "medium" => 20.weekdays_from(medium_priority_start_date),
        "low"    => 30.weekdays_from(low_priority_start_date)
